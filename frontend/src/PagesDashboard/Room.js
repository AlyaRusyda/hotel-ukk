...
export default class Room extends React.Component {
    ...
    handleSave = (e) => {
        ...
        if (this.state.action === "insert") {
            ...
            let url = "http://localhost:3000/kamar/" + this.state.id
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-indigo-100 text-indigo-800">
                                                                {item.room_type.nama_tipe_kamar}
                                                            </span>
                                                        </td>
                                                        {this.state.role === "admin" &&
                                                            <td className="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="px-6 py-6 lg:px-8">
                                ...
                                <form class="space-y-6" onSubmit={(event) => this.handleSave(event)}>
                                    <div>
                                        ...
                                        <input type="text" name="room_number" id="room_number" value={this.state.nomor_kamar} onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan number of room" required />
                                    </div>
                                    <div>
